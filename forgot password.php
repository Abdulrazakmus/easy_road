...
<form class="login-form text-center">
    ...
    <div class="form-group">
        ...
        rounded-pill form-control-lg shadow" placeholder="Email" required>
    </div>


    <button type="submit" class="btn mt-2 btn-custom text-uppercase active btn-block rounded-pill  shadow"> <strong>Send</strong></button>
    <p class="mt-3 fornt-weight-normal">
        Back to <a href="login form.html"><strong>Login</strong></a>
